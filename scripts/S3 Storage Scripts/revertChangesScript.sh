...
if grep -q '<img src="https://craig-friday13-to-bear-bucket.s3.eu-west-1.amazonaws.com/image.jpg" alt="Bear Image">' repo/springapi/src/main/resources/templates/home.html; then
    # The modified string exists, revert it back
    echo -e "\x1b[32mReverting Image Replacement...\x1b[0m"
    sudo sed -i 's#<img src="https://craig-friday13-to-bear-bucket.s3.eu-west-1.amazonaws.com/image.jpg" alt="Bear Image">#<img src="/images/friday13th.jpg" alt="friday13thposter">#g' repo/springapi/src/main/resources/templates/home.html
else
...
aws s3 rb s3://craig-friday13-to-bear-bucket --force
