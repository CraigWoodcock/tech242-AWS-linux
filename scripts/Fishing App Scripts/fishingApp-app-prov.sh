...
echo "renaming application.properties"
...
export DB_HOST=jdbc:mysql://fishing-app-rds.c7gmy88u4cxu.eu-west-1.rds.amazonaws.com:3306/fishing_app
export DB_USER=root
export DB_PASS=rootpassword
export DB_IP=fishing-app-rds.c7gmy88u4cxu.eu-west-1.rds.amazonaws.com
