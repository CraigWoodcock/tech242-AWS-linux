...
#download FishingApp.sql
echo -e "\x1b[32mSaving SQL File...\x1b[0m"
curl -o FishingApp.sql https://raw.githubusercontent.com/CraigWoodcock/Fishing-App/main/src/main/resources/FishingApp.sql
echo -e "\x1b[32mFile Saved...\x1b[0m"
echo " "

# Run FishingApp script
echo -e "\x1b[32mExecuting Script...\x1b[0m"
echo " "
sudo mysql < FishingApp.sql
echo -e "\x1b[32mDone...\x1b[0m"
echo " "
...
echo "creating user..."
sudo mysql -e "CREATE USER 'root'@'%' IDENTIFIED BY 'rootpassword';"
