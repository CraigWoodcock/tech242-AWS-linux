...
echo -e "\x1b[32mUpdating ALternatives\x1b[0m"
echo " "
...
export DB_HOST=jdbc:mysql://172.31.37.62:3306/fishing_app
export DB_USER=root
export DB_PASS=rootpassword
export DB_IP=172.31.37.62
...
echo -e "\x1b[32m$ADMIN_EMAIL\x1b[0m"
echo " "
echo -e "\x1b[32mDone...\x1b[0m"
